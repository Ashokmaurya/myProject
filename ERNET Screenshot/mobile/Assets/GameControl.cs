...
public class GameControl : MonoBehaviour {
    ...
    private static GameObject whoWinsTextShadow;
       // , player1MoveText, player2MoveText,player3MoveText, player4MoveText;
...
//
       ...
       /* if (player4.GetComponent<FollowThePath>().waypointIndex > 
        ...
        /*if (player3.GetComponent<FollowThePath>().waypointIndex ==            player3.GetComponent<FollowThePath>().waypoints.Count)
        {
            whoWinsTextShadow.gameObject.SetActive(true);
